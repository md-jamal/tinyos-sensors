...
union __dmath;
#line 150
extern float powf(float arg_0x40355eb8, float arg_0x40359030);
#line 220
struct exception {
...
enum __nesc_unnamed4269 {
  OVERSAMPLING_ULTRA_LOW = 0x00, 
  OVERSAMPLING_STANDARD = 0x01, 
  OVERSAMPLING_HIGH_RES = 0x02, 
  OVERSAMPLING_ULTRA_HIGH_RES = 0x03
};
...
typedef TMilli BMPReadC__Timer__precision_tag;
...
typedef TMilli BMP180P__WaitTimer__precision_tag;
enum SerialAMQueueP____nesc_unnamed4290 {
  SerialAMQueueP__NUM_CLIENTS = 1U
};
enum /*PlatformSerialC.UartC*/Msp430Uart1C__0____nesc_unnamed4291 {
...
enum /*PlatformSerialC.UartC.UsciC*/Msp430UsciA1C__0____nesc_unnamed4292 {
...
static void BMPReadC__Boot__booted(void );
# 13 "BMP180.nc"
static void BMPReadC__BMP180__readDoneAltitude(error_t error, uint32_t altitude);


static void BMPReadC__BMP180__readDone(error_t error, uint16_t temperature, 
uint16_t pressure);
# 83 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
static void BMPReadC__Timer__fired(void );
# 45 "/opt/tinyos-cmote/tos/chips/msp430/timer/Msp430Compare.nc"
...
uint8_t arg_0x409139f0);
# 64 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
...
# 72 "/opt/tinyos-cmote/tos/interfaces/Leds.nc"
...
# 10 "BMP180.nc"
static error_t BMP180P__BMP180__readAltitude(uint32_t sealevel_pressure);
#line 6
static error_t BMP180P__BMP180__readPressure(void );
# 83 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
static void BMP180P__WaitTimer__fired(void );
# 22 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/I2C.nc"
static error_t MSP430I2CP__I2C__read(i2c_flags_t flags, 
uint16_t addr, uint8_t len, 
uint8_t *buf);
#line 14
static error_t MSP430I2CP__I2C__i2cInit(msp430_i2c_union_config_t i2c_config, 
...
#line 73
static uint8_t HplMsp430UsciB0P__Usci__getUstat(void );
#line 170
...
# 10 "BMP180.nc"
static error_t BMPReadC__BMP180__readAltitude(uint32_t sealevel_pressure);
# 72 "/opt/tinyos-cmote/tos/interfaces/Leds.nc"
static void BMPReadC__Leds__led1On(void );
#line 56
static void BMPReadC__Leds__led0On(void );
#line 89
static void BMPReadC__Leds__led2On(void );
# 64 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
static void BMPReadC__Timer__startPeriodic(uint32_t dt);
# 20 "BMPReadC.nc"
static inline void BMPReadC__Boot__booted(void );




static inline void BMPReadC__Timer__fired(void );
...
static inline void BMPReadC__BMP180__readDone(error_t error, uint16_t temperature, 
uint16_t pressure);
...
static inline void BMPReadC__BMP180__readDoneAltitude(error_t error, uint32_t altitude);
# 41 "/opt/tinyos-cmote/tos/chips/msp430/timer/Msp430Compare.nc"
...
# 22 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/I2C.nc"
static error_t BMP180P__I2C__read(i2c_flags_t flags, 
uint16_t addr, uint8_t len, 
uint8_t *buf);
#line 14
static error_t BMP180P__I2C__i2cInit(msp430_i2c_union_config_t i2c_config, 
unsigned char slave_addr);


static error_t BMP180P__I2C__write(i2c_flags_t flags, 
unsigned char slave_address, 
uint8_t len, uint8_t *buf);
# 13 "BMP180.nc"
static void BMP180P__BMP180__readDoneAltitude(error_t error, uint32_t altitude);


static void BMP180P__BMP180__readDone(error_t error, uint16_t temperature, 
uint16_t pressure);
# 73 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
static void BMP180P__WaitTimer__startOneShot(uint32_t dt);
# 28 "BMP180P.nc"
int16_t BMP180P__ac1;
#line 28
int16_t BMP180P__ac2;
#line 28
int16_t BMP180P__ac3;
uint16_t BMP180P__ac4;
#line 29
uint16_t BMP180P__ac5;
#line 29
uint16_t BMP180P__ac6;
int16_t BMP180P__b1;
#line 30
int16_t BMP180P__b2;
int16_t BMP180P__mb;
...
uint8_t BMP180P__buffer[3];

uint32_t BMP180P__compensated_temperature;
#line 35
uint32_t BMP180P__compensated_pressure;
uint32_t BMP180P__uncompensated_temperature;
uint32_t BMP180P__uncompensated_pressure;

uint8_t BMP180P__oversampling_select = OVERSAMPLING_ULTRA_LOW;

uint8_t BMP180P__state;

uint8_t BMP180P__user_state;

bool BMP180P__eeprom_read = FALSE;

uint32_t BMP180P__sea_level_pressure;

static error_t BMP180P__checkCommunication(void );
#line 67
static inline error_t BMP180P__I2Cinit(void );
#line 85
static inline uint16_t BMP180P__byte2Int(uint8_t msb, uint8_t lsb);
#line 100
static inline error_t BMP180P__readEEPROM(void );
#line 250
static inline uint32_t BMP180P__calculateTemperature(void );
#line 264
static int32_t BMP180P__calculatePressure(void );
#line 306
static inline void BMP180P__calculateAltitude(void );
#line 326
static inline error_t BMP180P__readTemperature(void );
#line 347
static inline void BMP180P__readPressure(void );
#line 368
static inline error_t BMP180P__BMP180__readPressure(void );
#line 394
static inline error_t BMP180P__BMP180__readAltitude(uint32_t sealevel_pressure);
#line 406
static inline void BMP180P__WaitTimer__fired(void );
# 192 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB.nc"
...
#line 73
static uint8_t MSP430I2CP__UsciB__getUstat(void );
#line 170
...
# 22 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
enum MSP430I2CP____nesc_unnamed4301 {
  MSP430I2CP__TIMEOUT = 2400
};
...
static inline error_t MSP430I2CP__checkSlave(unsigned char slave_addr);
#line 71
static inline error_t MSP430I2CP__I2C__i2cInit(msp430_i2c_union_config_t config, 
unsigned char slave_address);
#line 90
static error_t MSP430I2CP__I2C__write(i2c_flags_t flags, 
unsigned char slave_address, 
...
static void HplMsp430UsciB0P__USCL__selectModuleFunc(void );
#line 92
static void HplMsp430UsciB0P__USDA__selectModuleFunc(void );
# 75 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
...
#line 125
static inline uint8_t HplMsp430UsciB0P__Usci__getUstat(void );
...
# 39 "/opt/tinyos-cmote/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40623940){
#line 39
  switch (arg_0x40623940) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40623940);
#line 39
      break;
#line 39
    }
...
#line 162
# 80 "/opt/tinyos-cmote/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40ad9730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40ad9730, addr, msg, len);
#line 80
...
# 23 "/opt/tinyos-cmote/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40bb3088, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40bb3088) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40bb3088, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40bb3088){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40bb3088);
#line 15
      break;
#line 15
    }
...
# 102 "/opt/tinyos-cmote/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x40c14ec0){
#line 102
  switch (arg_0x40c14ec0) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x40c14ec0);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-cmote/tos/interfaces/Resource.nc"
inline static void /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40ce8bd0){
#line 102
  switch (arg_0x40ce8bd0) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40ce8bd0);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-cmote/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40ce6a58){
#line 59
  switch (arg_0x40ce6a58) {
#line 59
    case /*PlatformSerialC.UartC.UsciC*/Msp430UsciA1C__0__CLIENT_ID:
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40ce6a58);
#line 59
      break;
#line 59
    }
...
# 44 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x40c38eb0){
#line 44
  union __nesc_unnamed4280 *__nesc_result;
#line 44

#line 44
  switch (arg_0x40c38eb0) {
#line 44
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 44
...
#line 44
    default:
#line 44
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x40c38eb0);
#line 44
      break;
#line 44
    }
...
# 100 "/opt/tinyos-cmote/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40ab8d30, message_t * msg, error_t error){
#line 100
  switch (arg_0x40ab8d30) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40ab8d30, msg, error);
#line 100
      break;
#line 100
    }
...
# 110 "/opt/tinyos-cmote/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40aee948, message_t * msg, error_t error){
#line 110
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40aee948, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-cmote/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40bb4560, message_t * msg, error_t error){
#line 100
  switch (arg_0x40bb4560) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40bb4560, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-cmote/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x40b0f388, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x40b0f388, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-cmote/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x40bb7e50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40bb7e50) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x40bb7e50, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-cmote/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40bb3088, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40bb3088, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 65 "/opt/tinyos-cmote/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40ce6a58){
#line 65
  switch (arg_0x40ce6a58) {
#line 65
    case /*PlatformSerialC.UartC.UsciC*/Msp430UsciA1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40ce6a58);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-cmote/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__release(uint8_t arg_0x40c38478){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40c38478) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__default__release(arg_0x40c38478);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-cmote/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__isOwner(uint8_t arg_0x40c38478){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__default__isOwner(arg_0x40c38478);
#line 128
      break;
#line 128
    }
...
# 61 "/opt/tinyos-cmote/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40ce7690){
#line 61
    /*Msp430UsciShareA1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40ce7690);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-cmote/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__immediateRequest(uint8_t arg_0x40c38478){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsciResource__default__immediateRequest(arg_0x40c38478);
#line 97
      break;
#line 97
    }
...
# 49 "/opt/tinyos-cmote/tos/chips/msp430/pins/HplMsp430GeneralIORenP.nc"
static inline void /*HplMsp430GeneralIOC.P56*/HplMsp430GeneralIORenP__38__IO__clr(void )
#line 49
{
#line 49
...
# 53 "/opt/tinyos-cmote/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
...
#line 53
# 49 "/opt/tinyos-cmote/tos/chips/msp430/pins/Msp430GpioC.nc"
static inline void /*PlatformLedsC.Led2Impl*/Msp430GpioC__3__GeneralIO__clr(void )
#line 49
{
#line 49
...
# 41 "/opt/tinyos-cmote/tos/interfaces/GeneralIO.nc"
...
#line 41
# 104 "/opt/tinyos-cmote/tos/system/LedsP.nc"
static inline void LedsP__Leds__led2On(void )
#line 104
{
  LedsP__Led2__clr();
...
# 89 "/opt/tinyos-cmote/tos/interfaces/Leds.nc"
inline static void BMPReadC__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
...
#line 41
# 89 "/opt/tinyos-cmote/tos/system/LedsP.nc"
static inline void LedsP__Leds__led1On(void )
#line 89
{
  LedsP__Led1__clr();
...
# 72 "/opt/tinyos-cmote/tos/interfaces/Leds.nc"
inline static void BMPReadC__Leds__led1On(void ){
#line 72
  LedsP__Leds__led1On();
#line 72
}
...
#line 41
# 74 "/opt/tinyos-cmote/tos/system/LedsP.nc"
static inline void LedsP__Leds__led0On(void )
#line 74
{
  LedsP__Led0__clr();
...
# 56 "/opt/tinyos-cmote/tos/interfaces/Leds.nc"
inline static void BMPReadC__Leds__led0On(void ){
#line 56
  LedsP__Leds__led0On();
#line 56
}
#line 56
# 73 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
inline static void BMP180P__WaitTimer__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(1U, dt);
#line 73
}
#line 73
# 18 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/I2C.nc"
inline static error_t BMP180P__I2C__write(i2c_flags_t flags, unsigned char slave_address, uint8_t len, uint8_t *buf){
#line 18
  unsigned char __nesc_result;
#line 18
...
#line 332
  error = BMP180P__checkCommunication();
  if (error == SUCCESS) {
      BMP180P__buffer[0] = WRITE_REG;
      BMP180P__buffer[1] = TEMPERATURE_VALUE;
      BMP180P__I2C__write((I2C_INIT | I2C_START) | I2C_STOP, 
      BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);

      BMP180P__state = TEMPERATURE_MEASURE;
      BMP180P__WaitTimer__startOneShot(WAIT_PERIOD);
    }
  return error;
}
...
# 22 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/I2C.nc"
inline static error_t BMP180P__I2C__read(i2c_flags_t flags, uint16_t addr, uint8_t len, uint8_t *buf){
#line 22
  unsigned char __nesc_result;
#line 22
...
#line 103
  error = BMP180P__checkCommunication();
  if (error == SUCCESS) {
      if (!BMP180P__eeprom_read) {
          BMP180P__buffer[0] = AC1;

          BMP180P__I2C__write((I2C_INIT | I2C_START) | I2C_STOP, 
          BMP180_I2CSLAVE_ADDR, 1, BMP180P__buffer);

          BMP180P__I2C__read(I2C_START | I2C_STOP, 
          BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);

          BMP180P__ac1 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);





          BMP180P__buffer[0] = AC2;
          ...
          BMP180P__I2C__read(I2C_START | I2C_STOP, 
          BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);
          BMP180P__ac2 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);




          BMP180P__buffer[0] = AC3;
          ...
          BMP180P__ac3 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = AC4;
          ...
          BMP180P__ac4 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = AC5;
          ...
          BMP180P__ac5 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);





          BMP180P__buffer[0] = AC6;
          ...
          BMP180P__ac6 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = B1;
          ...
          BMP180P__b1 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = B2;
          ...
          BMP180P__b2 = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = MB;
          ...
          BMP180P__mb = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = MC;
          ...
          BMP180P__mc = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);



          BMP180P__buffer[0] = MD;
          ...
          BMP180P__md = BMP180P__byte2Int(BMP180P__buffer[0], BMP180P__buffer[1]);

          BMP180P__eeprom_read = TRUE;
        }
    }
...
# 125 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline uint8_t HplMsp430UsciB0P__Usci__getUstat(void )
#line 125
{
  return UCB0STAT;
...
# 73 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB.nc"
inline static uint8_t MSP430I2CP__UsciB__getUstat(void ){
#line 73
  unsigned char __nesc_result;
#line 73

#line 73
  __nesc_result = HplMsp430UsciB0P__Usci__getUstat();
#line 73
...
#line 73
# 346 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline bool HplMsp430UsciB0P__Usci__getStopBit(void )
#line 346
{
#line 346
...
#line 184
# 333 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__setTXStop(void )
#line 333
{
#line 333
...
#line 169
# 334 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__setTXStart(void )
#line 334
{
#line 334
...
#line 170
# 328 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__setTransmitMode(void )
#line 328
{
#line 328
...
#line 164
# 351 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__setSlaveAddress(uint16_t addr)
#line 351
{
#line 351
...
#line 192
# 35 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static inline error_t MSP430I2CP__checkSlave(unsigned char slave_addr)
{
  uint16_t i = 0;

#line 38
  MSP430I2CP__UsciB__setSlaveAddress(slave_addr);
...
#line 57
  ...
  return MSP430I2CP__UsciB__getUstat() & 0x08;
}
...
#line 161
# 28 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static inline void MSP430I2CP__setModeI2C(void )
{
...
#line 81
  ...
  return MSP430I2CP__checkSlave(slave_address);
}

# 14 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/I2C.nc"
inline static error_t BMP180P__I2C__i2cInit(msp430_i2c_union_config_t i2c_config, unsigned char slave_addr){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = MSP430I2CP__I2C__i2cInit(i2c_config, slave_addr);
#line 14
...
static inline error_t BMP180P__I2Cinit(void )
{
  ...
  return BMP180P__I2C__i2cInit(msp430_i2c_sht21_config, 
...
static inline error_t BMP180P__BMP180__readAltitude(uint32_t sealevel_pressure)
{
  ...
  BMP180P__sea_level_pressure = sealevel_pressure;

  BMP180P__user_state = ALTITUDE;

  return BMP180P__BMP180__readPressure();
}

# 10 "BMP180.nc"
inline static error_t BMPReadC__BMP180__readAltitude(uint32_t sealevel_pressure){
#line 10
  unsigned char __nesc_result;
#line 10

#line 10
  __nesc_result = BMP180P__BMP180__readAltitude(sealevel_pressure);
#line 10
...
static inline void BMPReadC__Timer__fired(void )
{
  if (BMPReadC__BMP180__readAltitude(1013) != SUCCESS) {
      BMPReadC__Leds__led0On();
      BMPReadC__Leds__led1On();
      BMPReadC__Leds__led2On();
    }
}
...
# 13 "BMP180.nc"
inline static void BMP180P__BMP180__readDoneAltitude(error_t error, uint32_t altitude){
#line 13
  BMPReadC__BMP180__readDoneAltitude(error, altitude);
#line 13
}
#line 13
# 306 "BMP180P.nc"
static inline void BMP180P__calculateAltitude(void )
{
  ...
  float calculate = (float )BMP180P__compensated_pressure / BMP180P__sea_level_pressure;
  ...
  BMP180P__state &= ~ALTITUDE_MEASURE;

  BMP180P__BMP180__readDoneAltitude(SUCCESS, altitude);
}
...
# 16 "BMP180.nc"
inline static void BMP180P__BMP180__readDone(error_t error, uint16_t temperature, uint16_t pressure){
#line 16
  BMPReadC__BMP180__readDone(error, temperature, pressure);
#line 16
}
#line 16
# 347 "BMP180P.nc"
static inline void BMP180P__readPressure(void )
{
  ...
  BMP180P__buffer[0] = WRITE_REG;
  BMP180P__buffer[1] = HUMIDITY_VALUE + (BMP180P__oversampling_select << 6);

  BMP180P__I2C__write((I2C_INIT | I2C_START) | I2C_STOP, 
  BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);

  BMP180P__state = PRESSURE_MEASURE;
  BMP180P__WaitTimer__startOneShot(WAIT_PERIOD);
}
...
static inline uint32_t BMP180P__calculateTemperature(void )
{
  int32_t B5;
  double temp;
  int32_t X1 = (BMP180P__uncompensated_temperature - (int32_t )BMP180P__ac6) * (int32_t )BMP180P__ac5 >> 15;
  int32_t X2 = ((int32_t )BMP180P__mc << 11) / (X1 + (int32_t )BMP180P__md);

#line 256
  B5 = X1 + X2;
  temp = (B5 + 8) >> 4;
  BMP180P__compensated_temperature = temp / 10;
  return BMP180P__compensated_temperature;
}
...
static inline void BMP180P__WaitTimer__fired(void )
{
  ...
  BMP180P__buffer[0] = READ_REG;
  BMP180P__I2C__write((I2C_INIT | I2C_START) | I2C_STOP, 
  BMP180_I2CSLAVE_ADDR, 1, BMP180P__buffer);

  if (BMP180P__state == TEMPERATURE_MEASURE) {
      BMP180P__I2C__read(I2C_START | I2C_STOP, 
      BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);

      BMP180P__uncompensated_temperature = (BMP180P__buffer[0] << 8) | BMP180P__buffer[1];




      BMP180P__calculateTemperature();
      BMP180P__readPressure();
    }
  else {
#line 425
    if (BMP180P__state == PRESSURE_MEASURE) {
        BMP180P__I2C__read(I2C_START | I2C_STOP, 
        BMP180_I2CSLAVE_ADDR, 2, BMP180P__buffer);
        BMP180P__uncompensated_pressure = BMP180P__buffer[0];
        BMP180P__uncompensated_pressure <<= 8;
        BMP180P__uncompensated_pressure |= BMP180P__buffer[1];
        BMP180P__uncompensated_pressure <<= 8;
        BMP180P__buffer[0] = READ_REG + 0x02;
        BMP180P__I2C__write((I2C_INIT | I2C_START) | I2C_STOP, 
        BMP180_I2CSLAVE_ADDR, 1, BMP180P__buffer);
        ...
        if (!(BMP180P__user_state & ALTITUDE)) {
          BMP180P__BMP180__readDone(SUCCESS, BMP180P__compensated_temperature, 
          BMP180P__calculatePressure());
          }
        else 
#line 447
          {
            BMP180P__calculatePressure();
            BMP180P__calculateAltitude();
          }
      }
    }
}
...
# 83 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x409139f0){
#line 83
  switch (arg_0x409139f0) {
#line 83
    case 0U:
#line 83
      BMPReadC__Timer__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      BMP180P__WaitTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x409139f0);
#line 83
      break;
#line 83
    }
...
#line 83
# 228 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__disableIntr(void )
#line 228
{
...
# 92 "/opt/tinyos-cmote/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
inline static void HplMsp430UsciB0P__USCL__selectModuleFunc(void ){
#line 92
...
# 92 "/opt/tinyos-cmote/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
inline static void HplMsp430UsciB0P__USDA__selectModuleFunc(void ){
#line 92
  /*HplMsp430GeneralIOC.P51*/HplMsp430GeneralIORenP__33__IO__selectModuleFunc();
#line 92
}
#line 92
# 268 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__enableI2C(void )
#line 268
{
  /* atomic removed: atomic calls only */
  {
    ...
    HplMsp430UsciB0P__USDA__selectModuleFunc();
    HplMsp430UsciB0P__USCL__selectModuleFunc();
  }
}
...
#line 97
# 253 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__tx(uint8_t data)
#line 253
{
...
#line 108
# 345 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline bool HplMsp430UsciB0P__Usci__getStartBit(void )
#line 345
{
#line 345
...
#line 185
# 329 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__setReceiveMode(void )
#line 329
{
#line 329
...
#line 165
# 202 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline bool HplMsp430UsciB0P__Usci__isRxIntrPending(void )
#line 202
{
...
#line 98
# 257 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline uint8_t HplMsp430UsciB0P__Usci__rx(void )
#line 257
{
...
#line 115
# 212 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__Usci__clrRxIntr(void )
#line 212
{
...
#line 62
# 154 "/opt/tinyos-cmote/tos/lib/timer/VirtualizeTimerC.nc"
static inline void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(uint8_t num, uint32_t dt)
{
...
# 64 "/opt/tinyos-cmote/tos/lib/timer/Timer.nc"
inline static void BMPReadC__Timer__startPeriodic(uint32_t dt){
#line 64
...
static inline void BMPReadC__Boot__booted(void )
{
  BMPReadC__Timer__startPeriodic(4096);
}
...
#line 58
# 197 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static inline void MSP430I2CP__Interrupts__rxDone(uint8_t data)
#line 197
{
}
...
#line 59
# 85 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__UsciRawInterrupts__rxDone(uint8_t temp)
#line 85
{
...
#line 53
# 193 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static inline void MSP430I2CP__Interrupts__txDone(void )
#line 193
{
}
...
#line 54
# 89 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static inline void HplMsp430UsciB0P__UsciRawInterrupts__txDone(void )
#line 89
{
...
# 79 "/opt/tinyos-cmote/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x40c100a0, uint8_t byte){
#line 79
  switch (arg_0x40c100a0) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x40c100a0, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x40c100a0, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x40c100a0) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x40c100a0, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 59 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciInterrupts.nc"
inline static void /*Msp430UsciShareA1P.UsciShareP*/Msp430UsciShareP__0__Interrupts__rxDone(uint8_t arg_0x40cdd5b8, uint8_t data){
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsciShareA1P.UsciShareP*/Msp430UsciShareP__0__Interrupts__default__rxDone(arg_0x40cdd5b8, data);
#line 59
      break;
#line 59
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x40c100a0, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x40c100a0) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x40c100a0, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 54 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciInterrupts.nc"
inline static void /*Msp430UsciShareA1P.UsciShareP*/Msp430UsciShareP__0__Interrupts__txDone(uint8_t arg_0x40cdd5b8){
#line 54
  switch (arg_0x40cdd5b8) {
#line 54
    case /*PlatformSerialC.UartC.UsciC*/Msp430UsciA1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsciShareA1P.UsciShareP*/Msp430UsciShareP__0__Interrupts__default__txDone(arg_0x40cdd5b8);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-cmote/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40623940){
#line 39
  switch (arg_0x40623940) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40623940);
#line 39
      break;
#line 39
    }
...
# 75 "/opt/tinyos-cmote/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x40587b30){
#line 75
  switch (arg_0x40587b30) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x40587b30);
#line 75
      break;
#line 75
    }
...
# 90 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static error_t MSP430I2CP__I2C__write(i2c_flags_t flags, 
unsigned char slave_address, 
uint8_t len, uint8_t *buf)
{
...
#line 122
      ...
      for (counter = 0xff; counter; counter--) ;
    }
  i = 0;
  if (flags & I2C_STOP) {
...
# 294 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/HplMsp430UsciB0P.nc"
static void HplMsp430UsciB0P__Usci__setModeI2C(msp430_i2c_union_config_t *config)
#line 294
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 142 "/opt/tinyos-cmote/tos/chips/msp430/x2xxx/usci/MSP430I2CP.nc"
static error_t MSP430I2CP__I2C__read(i2c_flags_t flags, 
uint16_t slave_address, uint8_t len, 
uint8_t *buffer)
{
...
#line 266
  int32_t p;
  int32_t X_1 = (BMP180P__uncompensated_temperature - (int32_t )BMP180P__ac6) * (int32_t )BMP180P__ac5 >> 15;
  int32_t X_2 = ((int32_t )BMP180P__mc << 11) / (X_1 + (int32_t )BMP180P__md);
  uint32_t B4;
#line 269
  uint32_t B7;
  ...
  X1 = (int32_t )BMP180P__b2 * (B6 * B6 >> 12) >> 11;
  X2 = (int32_t )BMP180P__ac2 * B6 >> 11;
  X3 = X1 + X2;
  B3 = ((((int32_t )BMP180P__ac1 * 4 + X3) << BMP180P__oversampling_select) + 2) / 4;

  X1 = (int32_t )BMP180P__ac3 * B6 >> 13;
  X2 = (int32_t )BMP180P__b1 * (B6 * B6 >> 12) >> 16;
  X3 = (X1 + X2 + 2) >> 2;
  B4 = (uint32_t )BMP180P__ac4 * (uint32_t )(X3 + 32768U) >> 15;
  B7 = ((uint32_t )BMP180P__uncompensated_pressure - B3) * 
  (uint32_t )(50000UL >> BMP180P__oversampling_select);
...
#line 291
  ...
  BMP180P__compensated_pressure = p + ((X1 + X2 + (int32_t )3791) >> 4);

  BMP180P__compensated_pressure /= 100;

  return BMP180P__compensated_pressure;
}
...
static error_t BMP180P__checkCommunication(void )
{
  ...
  if (BMP180P__buffer[0] == CHIPID_VALUE) {
    return SUCCESS;
    }
#line 63
  return FAIL;
